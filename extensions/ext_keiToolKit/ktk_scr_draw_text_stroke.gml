...
for (i = 0; i < 360; i += 360 / argument6){
    draw_text_transformed_color(argument0 + lengthdir_x(argument5, i), argument1 + lengthdir_y(argument5, i), string(argument2), 1, 1, 0, argument4, argument4, argument4, argument4, draw_get_alpha());
}
